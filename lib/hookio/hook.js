...
console.log( client.name.green, 'message'.red, '[', event.rainbow, ']', 'data'.green, data, 'group'.yellow, group)
...
console.log( this.name, 'message'.red, '[', event.rainbow, ']', 'data'.green, data)
