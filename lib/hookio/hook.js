...
console.log( this.name, 'message'.red, '[', client1.event.rainbow, ']', 'data'.green, data, 'group'.yellow, group)
...
console.log( this.name, 'message'.red, '[', client1.event.rainbow, ']', 'data'.green, data)
